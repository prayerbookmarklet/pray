...
readTextFile("https://raw.githubusercontent.com/prayerbookmarklet/pray/main/other/version.json", function(text){
  ...
  if (!hasValue)
  {
    prompt("Welcome to ant/jeospeeds prayer bookmarklet sucsesers of Vengeance ");
  }
});
